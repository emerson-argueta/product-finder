...
var _ Controller = &registerControllerMock{}

type registerControllerMock struct {
	Usecase       *usecase.RegisterUsecase
	Logger        *log.Logger
	Authorization authorization.JwtService
}

// NewRegisterControllerMock for register usecase
func NewRegisterControllerMock(identityRepos *persistence.ServicesMock, logger *log.Logger, authorizationService authorization.JwtService) Controller {
...
// Execute the usecase
func (ctrl *registerControllerMock) Execute(ctx echo.Context) (e error) {
