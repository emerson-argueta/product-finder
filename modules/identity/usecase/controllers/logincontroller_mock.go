...
var _ Controller = &loginControllerMock{}

type loginControllerMock struct {
	Usecase       *usecase.LoginUsecase
	Logger        *log.Logger
	Authorization authorization.JwtService
}

// NewLoginControllerMock for login usecase
func NewLoginControllerMock(identityRepos *persistence.ServicesMock, logger *log.Logger, authorizationService authorization.JwtService) Controller {
...
// Execute the usecase
func (ctrl *loginControllerMock) Execute(ctx echo.Context) (e error) {
