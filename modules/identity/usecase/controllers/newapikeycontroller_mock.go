...
var _ Controller = &apiKeyControllerMock{}

type apiKeyControllerMock struct {
	Usecase       *usecase.APIKeyUsecase
	Logger        *log.Logger
	Authorization authorization.JwtService
}

// NewAPIKeyControllerMock for search usecase
func NewAPIKeyControllerMock(identityRepos *persistence.ServicesMock, logger *log.Logger, authorizationService authorization.JwtService) Controller {
...
// Execute the usecase
func (ctrl *apiKeyControllerMock) Execute(ctx echo.Context) error {
